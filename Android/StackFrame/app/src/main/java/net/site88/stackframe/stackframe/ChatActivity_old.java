...
public class ChatActivity_old extends ActionBarActivity {
        ...
        BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                try {
                    ...
                    Toast.makeText(ChatActivity_old.this, "Something wrong with the message data", Toast.LENGTH_SHORT).show();
                }
